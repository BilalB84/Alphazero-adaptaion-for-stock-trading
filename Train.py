...
def train(model, env, mcts, num_iterations, batch_size, save_path="model.pth"):
    weight_decay = 1e-3  
...
def train_stock_model(stock_file, year, train_months, input_size, hidden_size, action_size, num_iterations=100, batch_size=32, save_path="model.pth"):
    ...
    total_losses, total_profits, total_rewards = train(agent, train_env, mcts, num_iterations=num_iterations, batch_size=batch_size, save_path=save_path)
